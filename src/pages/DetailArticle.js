                    ...
                    <div className="col-lg-4 mt-4">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb navigate-menu">
                                ...
                                <li className="breadcrumb-item"><Link to={'/articles'}>Article Choice</Link></li>
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <img src={API_URL+currentPost.data.image} className="img-fluid" style={{width:'100%'}} />
                                        </div>
                                    </div>
                                    <div className="row justify-content-end mt-4 mb-4">
                                        <div className="col-lg-10 col-10" style={{textAlign:'left'}}>
                                            <img src={blankProfile} className="rounded-circle float-start" width="50" height="50"/>
                                            <div className="row">
